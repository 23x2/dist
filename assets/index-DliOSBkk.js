(function(){const g=document.createElement("link").relList;if(g&&g.supports&&g.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))m(r);new MutationObserver(r=>{for(const d of r)if(d.type==="childList")for(const i of d.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&m(i)}).observe(document,{childList:!0,subtree:!0});function f(r){const d={};return r.integrity&&(d.integrity=r.integrity),r.referrerPolicy&&(d.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?d.credentials="include":r.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function m(r){if(r.ep)return;r.ep=!0;const d=f(r);fetch(r.href,d)}})();const Y="pl",X=["pl","en"],G={pl:{documentLang:"pl-PL",title:"23×2 Fundacja",label:"Polski"},en:{documentLang:"en-US",title:"23×2 Foundation",label:"English"}};function H(l){return l==="en"?"/?EN":"/"}function D(l){return`https://23x2.org${H(l)}`}const te={"title-23x2":{pl:"23×2<br>Fundacja — na styku psychologii<br>i sztuki",en:"23×2<br>Foundation<br>— At The Intersection Of Psychology<br>And Art"},"paragraph-chromosomes":{pl:"W genomie każdego człowieka znajdują się 23 pary chromosomów — to biologiczny fundament naszej różnorodności i jedności zarazem. Psychologia i sztuka, choć posługują się odmiennymi językami, mogą wspólnie służyć rozumieniu ludzkiego doświadczenia. Fundacja 23×2, utworzona w 2021 roku, działa na tym styku.",en:"Within every human genome are 23 pairs of chromosomes — the biological foundation of both our diversity and our unity. Psychology and art, though they use different languages, can complement one another in the effort to understand human experience. Established in 2021, the 23×2 Foundation works at this intersection."},"title-assumptions":{pl:"Obszary<br>działalności",en:"Areas<br>of work"},"paragraph-goal":{pl:"Fundacja została powołana do wspierania działań na styku psychologii, sztuki i technologii.",en:"The Foundation was established to support work at the intersection of psychology, art, and technology."},"paragraph-research":{pl:"<strong>Badania</strong><br> — projekty łączące podejście empiryczne z praktyką artystyczną.",en:"<strong>Research</strong><br> — projects combining empirical inquiry with artistic practice."},"paragraph-support":{pl:"<strong>Projekty interdyscyplinarne</strong><br> — przedsięwzięcia realizowane wspólnie przez artystów, badaczy i osoby zajmujące się technologią.",en:"<strong>Interdisciplinary projects</strong><br> — work carried out jointly by artists, researchers, and people working with technology."},"paragraph-tools":{pl:"<strong>Praktyka psychologiczna</strong><br> — działania wykorzystujące sztukę i technologię w pracy psychologicznej.",en:"<strong>Psychological practice</strong><br> — initiatives using art and technology in psychological work."},"paragraph-development":{pl:"Fundacja rozwija działalność stopniowo. Do współpracy zapraszamy osoby i instytucje działające w tych obszarach.",en:"The Foundation is developing its work gradually. We welcome contact from people and institutions active in these areas."},"title-contact":{pl:"Kontakt",en:"Contact"},"contact-email":{pl:'<a href="mailto:fundacja@23x2.org">fundacja@23x2.org</a>',en:'<a href="mailto:fundacja@23x2.org">fundacja@23x2.org</a>'},"title-phone":{pl:"tel.&thinsp;<strong>22&thinsp;100&thinsp;4420</strong>",en:"phone &thinsp;+48&thinsp;<strong>22&thinsp;100&thinsp;4420</strong>"},"contact-address":{pl:"<strong>Plac Konstytucji</strong> 3<br>00&#x2043;647 Warszawa",en:"<strong>Plac Konstytucji</strong> 3<br>00&#x2043;647 Warsaw"},"bank-account":{pl:"konto bankowe numer<br><strong>40 1600 1462 1747<br>7068 9000 0001</strong>",en:"bank account number<br><strong>40 1600 1462 1747<br>7068 9000 0001</strong>"},"footer-label":{pl:"23×2 Fundacja © 2021–2026",en:"23×2 Foundation © 2021–2026"},"footer-description":{pl:"Strona nie przetwarza danych osobowych ani nie używa ciasteczek.<br>Korzysta z odnawialnych źródeł energii.",en:"This website does not process personal data or use cookies.<br>It runs on renewable energy."},"cta-contact":{pl:"Zapraszamy do kontaktu",en:"Get in touch"}},j=3;let K=[],z=[],x=document.getElementById("connectionPath"),O=null,Z=0;function oe(){const l=document.querySelectorAll("#logo circle, #logo path");z=Array.from(l).map(g=>g.getAttribute("style").match(/fill: ([^;]+)/)[1])}function V(l,g,f){return l*(1-f)+g*f}function re(l){x.clientWidth;const g=x.clientHeight,m=document.getElementById("logo").getBoundingClientRect(),r=m.left+m.width/2;let d=Array(5).fill().map(()=>[]);for(let i=0;i<j;i++){const E=(i-j/2+.5)*10,L=r+E,h=r+E,w=5,b=150*(1+Math.sin(l*Math.PI)),y=1.5+l*2,v=l*Math.PI*2+i*Math.PI/j,s=[];for(let o=0;o<w;o++){const t=o/(w-1),n=Math.sin(t*Math.PI*y+v)*b,u=Math.cos(t*Math.PI*(y*1.5)+v)*(b*.5),a=V(L,h,t)+n*.5,c=V(0,g,t)+n+u;s.push({x:a,y:c}),d[o].push({x:a,y:c})}s[0].y=0,s[s.length-1].y=g;let S=`M ${s[0].x},${s[0].y}`;for(let o=0;o<s.length-1;o++){const t=s[o],n=s[o+1],u=(t.x+n.x)/2,a=(t.y+n.y)/2;S+=` Q ${t.x},${t.y} ${u},${a}`}S+=` L ${s[s.length-1].x},${s[s.length-1].y}`;let e=K[i];e||(e=document.createElementNS("http://www.w3.org/2000/svg","path"),K[i]=e,x.appendChild(e)),e.setAttribute("d",S),e.setAttribute("stroke",z[i%z.length]),e.setAttribute("fill","none"),e.setAttribute("stroke-width","1")}d.forEach((i,E)=>{if(i.length<2)return;let L=`M ${i[0].x},${i[0].y}`;for(let w=1;w<i.length-1;w++){const b=i[w-1],y=i[w],v=i[w+1],s=y.x-(v.x-b.x)*.2,S=y.y-(v.y-b.y)*.2,e=y.x+(v.x-b.x)*.2,o=y.y+(v.y-b.y)*.2;L+=` C ${s},${S} ${e},${o} ${v.x},${v.y}`}let h=x.querySelector(`#connecting-${E}`);h||(h=document.createElementNS("http://www.w3.org/2000/svg","path"),h.id=`connecting-${E}`,x.appendChild(h)),h.setAttribute("d",L),h.setAttribute("stroke",z[E%z.length])})}let J=performance.now();function Q(l){l||(l=performance.now());const g=l-J;J=l;let f=window.scrollY/Math.max(1,document.documentElement.scrollHeight-window.innerHeight);f=Math.max(0,Math.min(1,f));const m=1-Math.exp(-.00632*g),r=V(Z,f,m);re(r),Z=r,O=requestAnimationFrame(Q)}oe();x.style.position="fixed";x.style.top="0";x.style.left="0";x.style.pointerEvents="none";x.style.zIndex="1";Q();window.addEventListener("pagehide",()=>{O&&cancelAnimationFrame(O)});(()=>{const f=`
    let gl = null;
    let program = null;
    let vao = null;
...
function setupAttributes(gl, program) {
  ...
  `;function m(){if(!("OffscreenCanvas"in window)||!("transferControlToOffscreen"in HTMLCanvasElement.prototype)){console.warn("Required features not supported"),document.body.classList.remove("hidden");return}const e=new Blob([f],{type:"application/javascript"}),o=URL.createObjectURL(e),t=document.createElement("canvas");t.classList.add("webgl-overlay"),t.style.position="fixed",t.style.width="120vw",t.style.height="150vh",t.style.top="-25vh",t.style.left="-10vw",document.body.insertBefore(t,document.body.firstChild);const n=()=>{const A=window.visualViewport,B=t.getBoundingClientRect(),N=Math.max(1,B.width||window.innerWidth),C=Math.max(1,B.height||window.innerHeight),I=window.devicePixelRatio||1,q=Math.max(1,Math.trunc(N*I)),W=Math.max(1,Math.trunc(C*I)),ee=window.scrollY+((A==null?void 0:A.offsetTop)??0);return{width:q,height:W,cssWidth:N,cssHeight:C,viewportHeight:C,pixelRatio:I,aspectRatio:q/Math.max(W,1),scrollY:ee}},u=n(),a=t.transferControlToOffscreen(),c=new Worker(o);c.postMessage({action:"init",offscreen:a,...u},[a]);const P=()=>{c.postMessage({action:"updateViewport",...n()})};let U=!1;const k=()=>{U||(U=!0,requestAnimationFrame(()=>{U=!1,!_&&P()}))},F=()=>{k()},M=()=>{k()},$=()=>{c.postMessage({action:document.hidden?"stop":"resume"})},p=window.visualViewport,R="ResizeObserver"in window?new ResizeObserver(()=>{k()}):null;window.addEventListener("resize",F,{passive:!0}),window.addEventListener("scroll",M,{passive:!0}),document.addEventListener("visibilitychange",$),p==null||p.addEventListener("resize",F,{passive:!0}),p==null||p.addEventListener("scroll",M,{passive:!0}),R==null||R.observe(t),c.onmessage=A=>{A.data.action==="initialized"&&document.body.classList.remove("hidden")};let _=!1;const T=()=>{_||(_=!0,window.removeEventListener("resize",F),window.removeEventListener("scroll",M),document.removeEventListener("visibilitychange",$),p==null||p.removeEventListener("resize",F),p==null||p.removeEventListener("scroll",M),R==null||R.disconnect(),window.removeEventListener("beforeunload",T),window.removeEventListener("pagehide",T),c.postMessage({action:"stop"}),c.terminate(),URL.revokeObjectURL(o),t&&t.parentNode&&t.parentNode.removeChild(t))};return window.addEventListener("beforeunload",T),window.addEventListener("pagehide",T),T}"fonts"in document?document.fonts.ready.then(()=>{m()}):document.readyState==="loading"?document.addEventListener("DOMContentLoaded",m):m();let r=null;function d(){const e=new URLSearchParams(window.location.search);return e.has("en")||e.has("EN")?"en":Y}function i(){document.querySelectorAll('link[rel="alternate"][hreflang]').forEach(e=>{const o=e.getAttribute("hreflang");o==="x-default"?e.href=D(Y):X.includes(o)&&(e.href=D(o))})}function E(e){const o=G[e];if(!o)return;document.documentElement.lang=o.documentLang,document.title=o.title;const t=document.querySelector('link[rel="canonical"]');t&&(t.href=D(e)),i()}function L(e){document.querySelectorAll(".language-switcher a").forEach(o=>{var n;const t=o.dataset.lang;o.href=H(t),o.title=((n=G[t])==null?void 0:n.label)||t,o.classList.toggle("active",t===e),t===e?o.setAttribute("aria-current","page"):o.removeAttribute("aria-current")})}function h(){if(!window._paq)return;const e=`${window.location.pathname}${window.location.search}${window.location.hash}`;window._paq.push(["setCustomUrl",e]),window._paq.push(["setDocumentTitle",document.title]),window._paq.push(["trackPageView"])}function w(){document.querySelectorAll("[data-translate]").forEach(e=>{const o=40+Math.random()*640,t=280+Math.random()*520;e.dataset.fadeDelayMs=String(Math.round(o)),e.dataset.fadeDurationMs=String(Math.round(t)),e.style.setProperty("--fade-delay",`${(o/1e3).toFixed(3)}s`),e.style.setProperty("--fade-duration",`${(t/1e3).toFixed(3)}s`)})}function b(e,{animate:o=!0}={}){const t=document.querySelectorAll("[data-translate]"),n=u=>{var c;let a=(c=te[u.dataset.translate])==null?void 0:c[e];if(a){const P=/(^|\s|>)([a-zA-ZąćęłńóśźżĄĆĘŁŃÓŚŹŻ]{1,3})\s+/g;a=a.replace(P,"$1$2&nbsp;"),a=a.replace(P,"$1$2&nbsp;"),u.innerHTML=a}u.offsetHeight,u.classList.add("visible")};document.body.style.visibility==="visible"&&o?(w(),t.forEach(u=>{u.classList.remove("visible");const a=parseInt(u.dataset.fadeDelayMs||"0",10),c=parseInt(u.dataset.fadeDurationMs||"300",10);window.setTimeout(()=>n(u),a+c+20)})):(t.forEach(n),document.body.style.visibility="visible",document.body.classList.remove("hidden"))}function y(e,{updateUrl:o=!0,historyMode:t="push",animate:n=!0,track:u=!0}={}){if(X.includes(e)){if(o){const a=new URL(window.location.href),c=new URL(H(e),window.location.origin);(a.search!==c.search||a.pathname!==c.pathname)&&(a.pathname=c.pathname,a.search=c.search,t==="replace"?window.history.replaceState({lang:e},"",a.href):window.history.pushState({lang:e},"",a.href))}E(e),b(e,{animate:n}),L(e),u&&h()}}function v(){return r&&r.disconnect(),r=new IntersectionObserver(e=>{e.forEach(o=>{const t=o.target;o.isIntersecting?t.style.color="#000":t.style.color="#E880A1"})},{threshold:.1,rootMargin:"0px"}),document.querySelectorAll("[data-translate]").forEach(e=>{r.observe(e)}),r}function s(){w(),document.querySelectorAll("[data-translate]").forEach(o=>{o.style.color="#E880A1"});const e=d();y(e,{updateUrl:!1,animate:!1,track:!1}),v(),h(),document.querySelector(".language-switcher").addEventListener("click",o=>{const t=o.target.closest("a[data-lang]");if(!t)return;o.preventDefault();const n=t.dataset.lang;n&&n!==d()&&y(n)}),window.addEventListener("beforeunload",()=>{r==null||r.disconnect()})}"fonts"in document?document.fonts.ready.then(()=>{s(),document.body.classList.remove("hidden")}):document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{s(),document.body.classList.remove("hidden")}):(s(),document.body.classList.remove("hidden")),window.addEventListener("popstate",()=>{y(d(),{updateUrl:!1,animate:!1,track:!0})});var S=window._paq=window._paq||[];S.push(["enableLinkTracking"]),function(){var e="https://viahorizon.com/matomo/";S.push(["setTrackerUrl",e+"matomo.php"]),S.push(["setSiteId","6"]);var o=document,t=o.createElement("script"),n=o.getElementsByTagName("script")[0];t.async=!0,t.src=e+"matomo.js",n.parentNode.insertBefore(t,n)}()})();

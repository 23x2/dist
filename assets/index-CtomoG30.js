...
function setupAttributes(gl, program) {
  ...
  `;function m(){if(!("OffscreenCanvas"in window)||!("transferControlToOffscreen"in HTMLCanvasElement.prototype)){console.warn("Required features not supported"),document.body.classList.remove("hidden");return}const e=new Blob([f],{type:"application/javascript"}),o=URL.createObjectURL(e),t=document.createElement("canvas");t.classList.add("webgl-overlay"),t.style.position="fixed",t.style.width="120vw",t.style.height="150vh",t.style.top="-25vh",t.style.left="-10vw",document.body.insertBefore(t,document.body.firstChild);const n=()=>{const T=window.visualViewport,N=t.getBoundingClientRect(),B=Math.max(1,N.width||window.innerWidth),C=Math.max(1,N.height||window.innerHeight),I=window.devicePixelRatio||1,q=Math.max(1,Math.trunc(B*I)),W=Math.max(1,Math.trunc(C*I)),ee=window.scrollY+((T==null?void 0:T.offsetTop)??0);return{width:q,height:W,cssWidth:B,cssHeight:C,viewportHeight:C,pixelRatio:I,aspectRatio:q/Math.max(W,1),scrollY:ee}},c=n(),a=t.transferControlToOffscreen(),u=new Worker(o);u.postMessage({action:"init",offscreen:a,...c},[a]);const P=()=>{u.postMessage({action:"updateViewport",...n()})};let k=!1;const M=()=>{k||(k=!0,requestAnimationFrame(()=>{k=!1,!_&&P()}))},F=()=>{M()},U=()=>{M()},V=()=>{u.postMessage({action:document.hidden?"stop":"resume"})},p=window.visualViewport,R="ResizeObserver"in window?new ResizeObserver(()=>{M()}):null;window.addEventListener("resize",F,{passive:!0}),window.addEventListener("scroll",U,{passive:!0}),document.addEventListener("visibilitychange",V),p==null||p.addEventListener("resize",F,{passive:!0}),p==null||p.addEventListener("scroll",U,{passive:!0}),R==null||R.observe(t),u.onmessage=T=>{T.data.action==="initialized"&&document.body.classList.remove("hidden")};let _=!1;const A=()=>{_||(_=!0,window.removeEventListener("resize",F),window.removeEventListener("scroll",U),document.removeEventListener("visibilitychange",V),p==null||p.removeEventListener("resize",F),p==null||p.removeEventListener("scroll",U),R==null||R.disconnect(),window.removeEventListener("beforeunload",A),window.removeEventListener("pagehide",A),u.postMessage({action:"stop"}),u.terminate(),URL.revokeObjectURL(o),t&&t.parentNode&&t.parentNode.removeChild(t))};return window.addEventListener("beforeunload",A),window.addEventListener("pagehide",A),A}"fonts"in document?document.fonts.ready.then(()=>{m()}):document.readyState==="loading"?document.addEventListener("DOMContentLoaded",m):m();let r=null;function d(){const e=new URLSearchParams(window.location.search);return e.has("en")||e.has("EN")?"en":Y}function i(){document.querySelectorAll('link[rel="alternate"][hreflang]').forEach(e=>{const o=e.getAttribute("hreflang");o==="x-default"?e.href=j(Y):X.includes(o)&&(e.href=j(o))})}function E(e){const o=G[e];if(!o)return;document.documentElement.lang=o.documentLang,document.title=o.title;const t=document.querySelector('link[rel="canonical"]');t&&(t.href=j(e)),i()}function L(e){document.querySelectorAll(".language-switcher a").forEach(o=>{var n;const t=o.dataset.lang;o.href=H(t),o.title=((n=G[t])==null?void 0:n.label)||t,o.classList.toggle("active",t===e),t===e?o.setAttribute("aria-current","page"):o.removeAttribute("aria-current")})}function h(){if(!window._paq)return;const e=`${window.location.pathname}${window.location.search}${window.location.hash}`;window._paq.push(["setCustomUrl",e]),window._paq.push(["setDocumentTitle",document.title]),window._paq.push(["trackPageView"])}function v(){document.querySelectorAll("[data-translate]").forEach((e,o)=>{const t=e.dataset.translate||`${e.tagName}:${o}`;let n=2166136261;for(let a=0;a<t.length;a+=1)n^=t.charCodeAt(a),n=Math.imul(n,16777619);const c=40+(n>>>0)%760;e.dataset.fadeDelayMs=String(c),e.style.setProperty("--fade-delay",`${(c/1e3).toFixed(3)}s`)})}function b(e,{animate:o=!0}={}){const t=document.querySelectorAll("[data-translate]"),n=c=>{var u;let a=(u=te[c.dataset.translate])==null?void 0:u[e];if(a){const P=/(^|\s|>)([a-zA-ZąćęłńóśźżĄĆĘŁŃÓŚŹŻ]{1,3})\s+/g;a=a.replace(P,"$1$2&nbsp;"),a=a.replace(P,"$1$2&nbsp;"),c.innerHTML=a}c.offsetHeight,c.classList.add("visible")};document.body.style.visibility==="visible"&&o?t.forEach(c=>{c.classList.remove("visible");const a=parseInt(c.dataset.fadeDelayMs||"0",10);window.setTimeout(()=>n(c),a+320)}):(t.forEach(n),document.body.style.visibility="visible",document.body.classList.remove("hidden"))}function w(e,{updateUrl:o=!0,historyMode:t="push",animate:n=!0,track:c=!0}={}){if(X.includes(e)){if(o){const a=new URL(window.location.href),u=new URL(H(e),window.location.origin);(a.search!==u.search||a.pathname!==u.pathname)&&(a.pathname=u.pathname,a.search=u.search,t==="replace"?window.history.replaceState({lang:e},"",a.href):window.history.pushState({lang:e},"",a.href))}E(e),b(e,{animate:n}),L(e),c&&h()}}function y(){return r&&r.disconnect(),r=new IntersectionObserver(e=>{e.forEach(o=>{const t=o.target;o.isIntersecting?t.style.color="#000":t.style.color="#E880A1"})},{threshold:.1,rootMargin:"0px"}),document.querySelectorAll("[data-translate]").forEach(e=>{r.observe(e)}),r}function s(){v(),document.querySelectorAll("[data-translate]").forEach(o=>{o.style.color="#E880A1"});const e=d();w(e,{updateUrl:!1,animate:!1,track:!1}),y(),h(),document.querySelector(".language-switcher").addEventListener("click",o=>{const t=o.target.closest("a[data-lang]");if(!t)return;o.preventDefault();const n=t.dataset.lang;n&&n!==d()&&w(n)}),window.addEventListener("beforeunload",()=>{r==null||r.disconnect()})}"fonts"in document?document.fonts.ready.then(()=>{s(),document.body.classList.remove("hidden")}):document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{s(),document.body.classList.remove("hidden")}):(s(),document.body.classList.remove("hidden")),window.addEventListener("popstate",()=>{w(d(),{updateUrl:!1,animate:!1,track:!0})});var S=window._paq=window._paq||[];S.push(["enableLinkTracking"]),function(){var e="https://viahorizon.com/matomo/";S.push(["setTrackerUrl",e+"matomo.php"]),S.push(["setSiteId","6"]);var o=document,t=o.createElement("script"),n=o.getElementsByTagName("script")[0];t.async=!0,t.src=e+"matomo.js",n.parentNode.insertBefore(t,n)}()})();
